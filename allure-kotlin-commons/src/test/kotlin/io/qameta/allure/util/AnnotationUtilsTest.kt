...
import io.qameta.allure.util.AnnotationUtilsTest.Features.FeatureB.Story2
import io.qameta.allure.util.ResultsUtils.EPIC_LABEL_NAME
import io.qameta.allure.util.ResultsUtils.FEATURE_LABEL_NAME
import io.qameta.allure.util.ResultsUtils.STORY_LABEL_NAME
...
internal class AnnotationUtilsTest {
    ...
    @io.qameta.allure.Link(name = "LINK-1")
    @Links(
        io.qameta.allure.Link(
            name = "LINK-2",
            url = "https://example.org/link/2"
        ),
        io.qameta.allure.Link(url = "https://example.org/some-custom-link")
    )
    @TmsLink("TMS-1")
    ...
    internal annotation class Features {
        ...
        @Feature("A")
        @Owner("tester1")
        @io.qameta.allure.Link(url = "https://example.org/features/A")
        ...
        @Feature("B")
        @Owner("tester2")
        @io.qameta.allure.Link(url = "https://example.org/features/B")
